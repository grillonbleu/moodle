...
$string['maxsize'] = 'Maximum folder total size (MB)';
$string['maxsize_help'] = 'The maximum total size a folder may contain. If set to zero, the folder size is unlimited.';
$string['defaultmaxsize'] = 'Default maximum folder total size (MB)';
$string['defaultmaxsize_help'] = 'The default maximum total size a folder may contain. If set to zero, the folder size is unlimited.';
$string['maxsize_error'] = 'Total folder size cannot be greater than {$a->max} MB. {$a->submitted} MB submitted.';
